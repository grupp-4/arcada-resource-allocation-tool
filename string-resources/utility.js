export const cap = function cap(string) {
    return string.replace(/^\w/, cap => cap.toUpperCase())
}

export const mergeResources = function mergeResources(fallbackResources, resources, setName, log) {
...
export default {cap, mergeResources}
